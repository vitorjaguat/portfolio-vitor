  ...
  return (
    <div className='w-full dark:bg-zinc-600 pb-40'>
      <div className='w-screen h-[30vh] lg:h-[40vh] relative overflow-hidden'>
        <div className='absolute top-0 left-0 w-full h-[30vh] lg:h-[40vh] z-[3] bg-[url("/assets/projects/cabanagem200.png")] opacity-30 dark:opacity-90 dark:brightness-[0.35] bg-cover bg-repeat bg-bottom' />
        {/* <Image
