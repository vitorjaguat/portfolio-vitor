  ...
  return (
    <div className='w-full dark:bg-zinc-600 pb-40'>
      <div className='w-screen h-[30vh] lg:h-[40vh] relative overflow-hidden'>
        <div className='absolute top-0 left-0 w-full h-[30vh] lg:h-[40vh] z-[3] bg-[url("/assets/projects/moreabstract.png")] opacity-30 dark:opacity-90 dark:brightness-[0.35] bg-cover bg-repeat bg-bottom' />
        {/* <Image
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8 dark:text-gray-200'>
        <div className='col-span-4'>
          ...
          <div className='flex justify-center'>
            <a
              href='https://github.com/vitorjaguat/auction-page3'
              target='_blank'
              rel='noreferrer'
            >
