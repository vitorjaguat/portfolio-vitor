  ...
  return (
    <div className='w-full'>
      <div className='w-screen h-[30vh] lg:h-[40vh] relative overflow-hidden'>
        <div className='absolute top-0 left-0 w-full h-[30vh] lg:h-[40vh] z-[3] bg-[url("/assets/projects/hanzi.png")] opacity-50 bg-cover bg-repeat bg-bottom' />
        {/* <Image
        ...
        <div className='h-fit col-span-4 md:col-span-1 shadow-md shadow-gray-400 rounded-xl p-4'>
          <div className='p-2'>
            ...
            <div className='grid grid-cols-3 md:grid-cols-1'>
              ...
              <p className='text-gray-600 py-2 flex items-center'>
                <FiCheck size={25} className='pr-3' /> NPM
              </p>
              {/* <p className='text-gray-600 py-2 flex items-center'>
